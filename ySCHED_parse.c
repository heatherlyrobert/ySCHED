 ...
 *> ySCHED_parse       (void **a_sched, char *a_recd)                                               <* 
 *> {                                                                                               <* 
 *>    /+---(locals)-----------+-----+-----+-+/                                                     <* 
 *>    char        rce         =  -10;                                                              <* 
 *>    int         len         =    0;                                                              <* 
 ...
 *>       return rce;                                                                               <* 
 *>    }                                                                                            <* 
 *>    strncpy (g_curr->valid, mySCHED.valid, LEN_VALID);                                           <* 
 *>    DEBUG_YSCHED  yLOG_info  ("effout"   , mySCHED.effout);                                      <* 
 *>    /+---(copy back)----------------------+/                                                     <* 
 *>    /+> if (a_sched != NULL)   ySCHED_save (a_sched);                                  <+/       <* 
 *>    /+---(complete)-----------------------+/                                                     <* 
 *>    DEBUG_YSCHED  yLOG_exit    (__FUNCTION__);                                                   <* 
 *>    return 0;                                                                                    <* 
 *> }                                                                                               <*/
